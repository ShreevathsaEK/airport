...
const SearchForm = () => {
  ...
  //function to handle ther selection of a name of airport from the dropdown provided
  const selectAirport = (value) => {
    setDepartureAirport(value);
    setFilteredAirports([]);
  };
  //funtion to get a data of airport from the server
...
//airport handler controller and eroor msg generator
  ...
  //parking check in handler control
  ...
  //ckeout date handling and validation
